...
export default function About() {
  return ( 
    <div>
        <Header/>
        <Text header="About" copy="I'm currently a Frontend Engineer at Persado, working at the intersection of engineering and customer success. I love solving technical challenges for enterprise customers, building tools that improve workflows, and creating documentation that empowers developers. I believe the best products come from deep customer empathy and continuous iteration."/>
