  ...
  return ( 
    <div>
        ...
        <h2 className="text-bold text-2xl font-custom py-0.5 font-medium text-slate-800 mb-8">Experience</h2>
            <Experience logo={Persadologo} alt="Persado company logo." company="Persado" role="Solutions Software Engineer | Service Delivery" start="February 2025" end="Present" />  
