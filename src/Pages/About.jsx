  ...
  return ( 
    <div>
        ...
        <h2 className="text-bold text-2xl font-custom py-0.5 font-medium text-slate-800 mb-8">Experience</h2>
            <Experience logo={nebulaImg} alt="Nebula Project freelance creative agency." company="Nebula Project" role="Full stack software engineer." start="March 2024" end="Current" />
